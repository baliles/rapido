...
@Service
public class DeodongskokvdkProcedureExecutorServiceImpl implements DeodongskokvdkProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeodongskokvdkProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("deodongskokvdkWMProcedureExecutor")
