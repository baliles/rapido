...
import com.rapido.deodongskokvdk.service.AccountService;
 ...
 * @see Account
 */
@RestController("deodongskokvdk.AccountController")
@Api(value = "AccountController", description = "Exposes APIs to work with Account resource.")
@RequestMapping("/deodongskokvdk/Account")
public class AccountController {

    private static final Logger LOGGER = LoggerFactory.getLogger(AccountController.class);

    @Autowired
	@Qualifier("deodongskokvdk.AccountService")
