...
import com.rapido.deodongskokvdk.service.DeodongskokvdkProcedureExecutorService;

@RestController(value = "Deodongskokvdk.ProcedureExecutionController")
@RequestMapping("/deodongskokvdk/procedureExecutor")
@Api(value = "ProcedureExecutionController", description = "controller class for procedure execution")
public class ProcedureExecutionController {


    @Autowired
    private DeodongskokvdkProcedureExecutorService procedureService;
