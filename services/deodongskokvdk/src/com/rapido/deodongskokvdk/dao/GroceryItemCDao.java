...
/**
 * Specifies methods used to obtain and modify GroceryItemC related information
 * which is stored in the database.
 */
@Repository("deodongskokvdk.GroceryItemCDao")
public class GroceryItemCDao extends WMGenericDaoImpl<GroceryItemC, Long> {
