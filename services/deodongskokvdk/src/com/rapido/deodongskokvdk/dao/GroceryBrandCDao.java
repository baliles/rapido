...
package com.rapido.deodongskokvdk.dao;
...
/**
 * Specifies methods used to obtain and modify GroceryBrandC related information
 * which is stored in the database.
 */
@Repository("deodongskokvdk.GroceryBrandCDao")
public class GroceryBrandCDao extends WMGenericDaoImpl<GroceryBrandC, Integer> {

    @Autowired
    @Qualifier("deodongskokvdkTemplate")
